...
import {
  ...
  idlePlayerRight,
  idlePlayerUp,
  walkGPlayerDown_stepA,
  walkGPlayerDown_stepB,
  walkGPlayerLeft_stepB,
  walkGPlayerRight_stepA,
  walkGPlayerRight_stepB,
  walkGPlayerUp_stepA,
  walkGPlayerUp_stepB,
  walkPGlayerLeft_stepA,
  ...
  GIRL: {
    world: {
      foot: {
        idle: {
          up: idleGPlayerUp,
          down: idleGPlayerDown,
          left: idleGPlayerLeft,
          right: idleGPlayerRight,
        },
        jump: {
          up: idleGPlayerUp,
          down: idleGPlayerDown,
        ...
        walk: {
          up: [walkGPlayerUp_stepA, walkGPlayerUp_stepB],
          down: [walkGPlayerDown_stepA, walkGPlayerDown_stepB],
          left: [walkPGlayerLeft_stepA, walkGPlayerLeft_stepB],
          right: [walkGPlayerRight_stepA, walkGPlayerRight_stepB],
        },
      },
      bike: {
        idle: {
