import { EMBER_ANIMATION } from "../../../../render/config/battle/pokemon/moves/emberAnimation.config.js";
import { SpriteViewer } from "../../../SpriteViewer/SpriteViewer.model.js";

export class EmberAnimation {
  constructor(game, viewers, turnAction) {
    ...
    this.viewer.sprite.position.y = this.targetViewer.sprite.position.y + 20;
